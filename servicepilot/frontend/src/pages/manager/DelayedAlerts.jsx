  ...
  return (
    <div className="animate-fade-in space-y-6">
      <div>
        ...
        <p className="text-surface-500 text-sm mt-0.5">{delayed.length} vehicles exceeding expected turnaround time</p>
      </div>
          ...
          return (
            <div key={v.id} className={`card p-4 flex items-center gap-4 border-l-4 ${color === 'red' ? 'border-l-red-500' : 'border-l-orange-400'}`}>
              <div className="flex-1 grid grid-cols-2 sm:grid-cols-5 gap-3">
                ...
                <div>
                  <div className="text-xs text-surface-400">Days / Over</div>
