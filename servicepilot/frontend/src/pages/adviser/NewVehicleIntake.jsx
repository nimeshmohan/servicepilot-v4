...
export default function NewVehicleIntake() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.jobCardNumber) return toast.error('Job card number is required');
        ...
        <FormSection title="Vehicle Information">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Field label="Job Card Number *">
              <input name="jobCardNumber" className="input" placeholder="JC-2024-001" value={form.jobCardNumber} onChange={handleChange} required />
            </Field>
          </div>
        </FormSection>
